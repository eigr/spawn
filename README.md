# Spawn
![last commit](https://img.shields.io/github/last-commit/eigr/spawn?style=social) • ![ci](https://github.com/eigr/spawn/actions/workflows/ci.yaml/badge.svg) • ![release](https://github.com/eigr/spawn/actions/workflows/release.yaml/badge.svg)
...
```shell
kubectl create ns eigr-functions && curl -L https://github.com/eigr/spawn/releases/download/v0.5.0-rc.6/manifest.yaml | kubectl apply -f -
```

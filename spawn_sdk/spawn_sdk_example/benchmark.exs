# Simples tests
# Run with:
# PROXY_CLUSTER_STRATEGY=epmd PROXY_DATABASE_TYPE=mysql PROXY_DATABASE_POOL_SIZE=10 SPAWN_STATESTORE_KEY=3Jnb0hZiHIzHTOih7t2cTEPEpY98Tu1wvQkPfq/XwqE= mix run benchmark.exs
...
#Process.sleep(10000)
Benchee.run(%{
  "Non Parallel Stateful Singleton Actor                  - Get State   " => fn -> invok_get_state() end,
  "Non Parallel Stateful Singleton Actor                  - Update State" => fn -> invoke_update_state() end,
  "Non Parallel Stateful Abstract Spawn and Invoke Actor  - Update State" => fn -> spawn_and_invoke() end,
  "Non Parallel Stateless Pooled Actor                    - Call Action " => fn -> spawn_invoke_pooled_actors() end
  },
  parallel: 10,
  formatters: [
  {

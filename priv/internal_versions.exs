defmodule InternalVersions do
  ...
  @versions [
    ...
    spawn_sdk: "0.6.1",
    activator: "0.6.1",
    activator_grpc: "0.6.1",
    activator_http: "0.6.1",
    activator_kafka: "0.6.1",
    activator_pubsub: "0.6.1",
    activator_rabbitmq: "0.6.1",
    activator_sqs: "0.6.1",
    proxy: "0.6.1",
    spawn_operator: "0.6.1"
  ]

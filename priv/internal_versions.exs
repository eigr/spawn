defmodule InternalVersions do
  ...
  @versions [
    ...
    spawn: "0.5.0-alpha.7",
    spawn_sdk: "0.5.0-alpha.7",

    activator: "0.5.0-alpha.7",
    activator_grpc: "0.5.0-alpha.7",
    activator_http: "0.5.0-alpha.7",
    activator_kafka: "0.5.0-alpha.7",
    activator_pubsub: "0.5.0-alpha.7",
    activator_rabbitmq: "0.5.0-alpha.7",
    activator_sqs: "0.5.0-alpha.7",

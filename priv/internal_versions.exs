defmodule InternalVersions do
  ...
  @versions [
    ...
    activator: "0.5.0-rc.6",
    activator_grpc: "0.5.0-rc.6",
    activator_http: "0.5.0-rc.6",
    activator_kafka: "0.5.0-rc.6",
    activator_pubsub: "0.5.0-rc.6",
    activator_rabbitmq: "0.5.0-rc.6",
    activator_sqs: "0.5.0-rc.6",
